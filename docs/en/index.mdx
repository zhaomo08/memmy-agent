...
It distills your knowledge, preferences, and project experience into personal memory, and lets different Agents — Claude Code, Codex, OpenClaw, and more — share the same context.
...
- Turn your Claude Code and Codex history into memory
...
- People who use multiple AI coding/chat tools at once (Claude Code, Codex, Opencode, OpenClaw, Hermes) and want them to share one set of memory.
...
- Scan conversation history from Claude Code, Codex, and more; dedupe, ingest, and search it in one place.
