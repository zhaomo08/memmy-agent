...
Open "Memory → Cross-Agent access" and scan conversation history from Cursor, Claude Code, Codex, OpenCode, OpenClaw, Hermes, and WorkBuddy into the memory store. First-run onboarding lets you scan only or also install the matching Hook/plugin/Skill for detected Agents.
