...
- **Source attribution:** captured turns carry `claude_code`, `codex`, `opencode`, `openclaw`, or `hermes`, so you can filter and trace their origin.
...
2. For Claude Code and Codex, click **Install Hook**. For OpenCode, OpenClaw, and Hermes, click **Install plugin**.
